...
vim.keymap.set("n", "J", "mzJ`z", { desc = "appends next line to end of line" })

vim.keymap.set("n", "<C-d>", "<C-d>zz", { desc = "move down in buffer with cursor centered" })
vim.keymap.set("n", "<C-u>", "<C-u>zz", { desc = "move up in buffer with cursor centered" })
vim.keymap.set("n", "n", "nzzzv", { desc = "find up and center" })
vim.keymap.set("n", "N", "Nzzzv", { desc = "find down and center" })
